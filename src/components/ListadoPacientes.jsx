    ...
    return ( 
        <div className="md:w-1/2 lg:w-3/5 md:h-screen overflow-y-scroll">
            ...
            <>
                ...
                <p className="text-lg mt-5 text-center mb-5">Administra tus {""} 
                ...
                <p className="text-lg mt-5 text-center mb-5">Comienza agregando tus pacientes, {""} 
                    <span className="text-indigo-600 font-bold">se visualizaran en esta area!</span>
                </p>
                </>
            )
